    ...
    onSubmit: (values) => {
      purchase({
        ...
        products: items.map((item) => ({
          id: item.id,
          price: item.prices.current as number //cast, se o item chegou ate aqui é porque ele possui preço
        }))
      })
    }
  })
